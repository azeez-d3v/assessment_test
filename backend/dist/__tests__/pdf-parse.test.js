...
const pdf_parse_new_1 = __importDefault(require("pdf-parse-new"));
...
async function testPdfParse() {
    ...
    try {
        ...
        const result = await (0, pdf_parse_new_1.default)(minimalPDF);
        ...
        try {
            await (0, pdf_parse_new_1.default)(Buffer.from('not a pdf'));
...
testPdfParse();
//# sourceMappingURL=pdf-parse.test.js.map